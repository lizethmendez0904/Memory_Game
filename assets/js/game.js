...
constructor(contGameGame, level) {
  ...
  this.folderPath = "/Memory_Game/"; //name folder
  ...
  this.pathImg = this.serverPath + "assets/img/"; // path data imgs 
  this.pathImgDafault = this.serverPath + "assets/img/default.png"; // path data img default 
